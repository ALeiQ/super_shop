		...
		<form id="form1" name="form1" method="post" action="saveuser"
			...
			<div class="content">
				<table class="box">
					...
					<tr>
						...
						<td><input type="radio" name="uissupper" id="auth" value="0"
							checked="checked" />普通用户 <input type="radio" name="uissupper"
			...
			<div class="buttons">
				<input type="submit" name="button" id="button" value="数据提交"
					...
					id="button" onclick="window.location='userAdmin.jsp';" value="返回"
					class="input-button" />
			</div>
